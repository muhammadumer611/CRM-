...
class AdminSettingsController {
    ...
    public function index() {
        ...
        View::render('admin/settings/index', [
            ...
            'billingSettings' => $this->adminSettingsService->getBillingSettings()
        ], 'admin');
    }
    ...
    public function updateBilling() {
        ...
        $result = $this->adminSettingsService->updateBillingSettings($_POST);
        Session::set($result['success'] ? 'success' : 'error', $result['success'] ? 'Fee & Billing Settings saved.' : $result['error']);

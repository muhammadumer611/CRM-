...
<div class="card">
    ...
    <form method="POST" action="<?php echo $config['base_url']; ?>/reservations/convert/<?php echo (int)$reservation['id']; ?>">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group"><label class="form-label">CNIC</label><input type="text" name="cnic" class="form-control" value="<?php echo htmlspecialchars(\App\Services\StudentService::formatCnic($reservation['cnic'])); ?>" required></div>
            </div>
            <div class="col-md-6">
                <div class="form-group"><label class="form-label">Phone</label><input type="text" name="phone" class="form-control" value="<?php echo htmlspecialchars(\App\Services\StudentService::formatPhone($reservation['phone'])); ?>" required></div>
            </div>
            <div class="col-md-6">
